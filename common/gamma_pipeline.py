"""Baseline 4: Historical pipelined ancilla-free Gamma construction.

Fuses same-row T(x,x) with cross-row/skip-row T(x,y) into shared prefix
cascade sweeps.  It is retained as a historical baseline; the folded Gamma
construction in :mod:`common.gamma_folded` has lower depth.
...
def build_gamma_pipelined(L: int, sq=None):
    """Build the historical pipelined Gamma circuit (Baseline 4).
