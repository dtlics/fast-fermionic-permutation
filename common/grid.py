...
coordinate conversions, and the column parity cascade used by the
three legacy Gamma constructions.
"""
...
# ---------------------------------------------------------------------------
# Column parity cascade (shared by the Gamma constructions)
# ---------------------------------------------------------------------------
