...
from exp1_fp.collect import PUBLICATION_L_VALUES, run_experiment
...
def main():
    ...
    parser.add_argument("--p-values", nargs="+", type=float, default=[1e-4, 1e-5],
                        help="2-qubit gate error rates")
    parser.add_argument("--p-idle-factor", type=float, default=1.0,
                        help="p_idle = p_2q * factor (default: 1.0)")
    parser.add_argument("--shots", type=int, default=1_000_000,
                        help="Stim shots per instance (default: 1000000)")
    parser.add_argument("--workers", type=int, default=1,
                        help="Parallel permutation workers (default: 1)")
